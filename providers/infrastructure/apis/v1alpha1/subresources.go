...
// EnvRequest is the payload of the "env" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=env,scope=Cluster
...
// ExecRequest is the payload of the "exec" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=exec,scope=Cluster
...
// LogRequest is the payload of the "log" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=log,scope=Cluster
...
// ProcessRequest is the payload of the "process" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=process,scope=Cluster
...
// ProxyRequest is the payload of the "proxy" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
...
// RestartRequest is the payload of the "restart" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=restart,scope=Cluster
...
// RuntimeStatusRequest is the payload of the "runtime-status" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=runtime-status,scope=Cluster
...
// SyncRequest is the payload of the "sync" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=sync,scope=Cluster
...
// WorkspaceRequest is the payload of the "workspace" custom subresource on instances.
//
// +kubebuilder:object:root=true
// +kubebuilder:storageversion
// +kubebuilder:resource:path=workspace,scope=Cluster
